...
<body>
    ...
    <footer class="footer dark-mode  pt-5 pb-4 pb-lg-5" style="margin-top:50px; background-color: #4B49AC">
        <div class="container pt-lg-4">
            <p class="nav d-block text-white fs-xs text-center text-md-start pb-2 pb-lg-0 mb-0">
                &copy; Copyright 2022 - 2023 DISHUB SULSEL
            </p>
        </div>
    </footer>
